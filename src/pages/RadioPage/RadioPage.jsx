...
const RadioPage = () => {
    ...
    const [roomCountOne, setRoomCountOne] = useState('')
    const [roomCountTwo, setRoomCountTwo] = useState('')
    ...
    const handleSubmit = () => {
        console.log({
            ...
            priceType: priceType,
            roomCount: roomCount,
            roomCountOne: roomCountOne,
            roomCountTwo: roomCountTwo,
            adress: adress,
            phone: phone,
            email: email,
            username: username
                ...
                <div className="radios">
                    ...
                    <div className="displayflex radiotop-1">
                        <div>
                            ...
                            <input onChange={((e) => { setPrice(e.target.value) })} type="number" placeholder="400 000" className="radiotop1-input" />
                        </div>
                        <select onSelect={((e) => { setPriceType(e.target.value) })} name="" id="">
                    ...
                    <div className="displayflex radiotop2">
                        <div>
                            ...
                            <input onChange={((e) => { setRoomCount(e.target.value) })} type="number" placeholder="4" />

                            <input onChange={((e) => { setRoomCountOne(e.target.value) })} type="number" placeholder="900" />

                            <input onChange={((e) => { setRoomCountTwo(e.target.value) })} type="number" placeholder="90" />
                        </div>
                    </div>
                    ...
                    <div className="displayflex radiotop3">
                        <div>
                            ...
                            <div className="d-block">
                                <input onChange={((e) => { setAddress(e.target.value) })} type="radio" name="radiotop3" id="radiotop3-1" />
                                <label htmlFor="radiotop3-1">В городе</label>
                            </div>

                            <div className="d-block">
                                <input onChange={((e) => { setAddress(e.target.value) })} type="radio" name="radiotop3" id="radiotop3-2" />
                                <label htmlFor="radiotop3-2">В пригороде</label>
                            </div>

                            <div className="d-block">
                                <input onChange={((e) => { setAddress(e.target.value) })} type="radio" name="radiotop3" id="radiotop3-3" />
                        ...
                        <div>
                            <div className="d-block">
                                <input onChange={((e) => { setAddress(e.target.value) })} type="radio" name="radiotop3" id="radiotop3-4" />
                                <label htmlFor="radiotop3-4">Вдоль трассы</label>
                            </div>

                            <div className="d-block">
                                <input onChange={((e) => { setAddress(e.target.value) })} type="radio" name="radiotop3" id="radiotop3-5" />
                                <label htmlFor="radiotop3-5">Возле водоема, реки</label>
                            </div>

                            <div className="d-block">
                                <input onChange={((e) => { setAddress(e.target.value) })} type="radio" name="radiotop3" id="radiotop3-6" />
                        ...
                        <div>
                            <div className="d-block mb4">
                                <input onChange={((e) => { setAddress(e.target.value) })} type="radio" name="radiotop3" id="radiotop3-7" />
                                <label htmlFor="radiotop3-7">В дачном массиве</label>
                            </div>

                            <div className="d-block mb4">
                                <input onChange={((e) => { setAddress(e.target.value) })} type="radio" name="radiotop3" id="radiotop3-8" />
                    ...
                    <div className="karta">
                        ...
                        <div className="bottom-inputs">
                            <div>
                                ...
                                <input onChange={((e) => { setPhone(e.target.value) })} type="number" placeholder="+99894 888 74452" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input onChange={((e) => { setusername(e.target.value) })} type="text" placeholder="Зухриддин" />
                            </div>

                            <div className="buttons">
                                <button onClick={handleSubmit}>Добавить обьявления бесплатно</button>
